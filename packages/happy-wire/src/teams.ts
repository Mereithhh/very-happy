...
export type TeamState = { permissionMode?: TeamPermissionMode; schedules?: TeamSchedule[]; archivedAt?: number; id: string; name: string; machineId: string; version: number; bots: TeamBot[]; tasks: TeamTask[]; messages: TeamMessage[]; operations: TeamOperation[]; createdAt: number };
