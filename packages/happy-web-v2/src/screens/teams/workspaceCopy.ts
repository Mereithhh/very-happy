...
const en = {
  ...
  noTeams: 'Your first team starts with a conversation', noTeamsHint: 'Open a managed coding agent, load the official skill and describe your goal.',
  ...
  noMembers: 'Connect a lead to get started', members: 'Team members',
...
const zh: typeof en = {
  ...
  noTeams: '从一句需求，开始第一个团队', noTeamsHint: '打开托管的 coding agent，读取官方 skill，告诉它你想做什么。',
  noTasks: '准备好接收目标', noTasksHint: '让负责人检查一个项目，或开发一个功能。派出的任务会直接展示在这里。',
  noMembers: '先连接一位负责人', members: '团队成员',
