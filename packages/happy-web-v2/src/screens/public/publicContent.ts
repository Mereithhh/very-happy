  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'MCP handoffs into the Web workspace', blocks: [
        ...
        { type: 'note', text: 'This --scope user registration gives every Claude session for that OS user copy_to_clipboard; it is not bound to a Very Happy Web terminal. Inside a Very Happy terminal, it also provides title and preview tools through the local daemon. Native Pi loads these with very-happy pi --terminal. Copy and preview history is available inside each conversation and terminal; long content is marked as an excerpt. Tool availability varies by runner and is not a universal MCP promise.' },
      ] },
