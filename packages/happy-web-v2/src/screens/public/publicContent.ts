...
export const PUBLIC_DOCS: PublicDoc[] = [
  {
    ...
    sections: [
      ...
      { heading: '8. Learn the workspace', blocks: [
        { type: 'p', text: 'After the first machine connects, the home screen becomes a reusable guide. Start both a structured AI conversation and a real Web terminal, then open Settings to review appearance and language, agent defaults and review mode, saved shortcuts and terminal behavior, notifications, machines, channels, and clipboard handoffs.' },
