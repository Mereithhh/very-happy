...
function ProductShowcase() {
  return <section className="pub-product" aria-labelledby="product-title">
    <div className="pub-product-intro"><div><div className="eyebrow">THE REAL PRODUCT UI</div><h2 id="product-title">One workspace. Three levels of attention.</h2></div><p>After you explicitly install the optional Claude terminal hooks, the terminal and structured view can follow the same hand-started Claude process; the board steps back across your work. All three reuse production visual contracts with sanitized data.</p></div>
