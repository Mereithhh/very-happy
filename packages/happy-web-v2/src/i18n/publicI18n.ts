...
const en = {
  ...
  landing: {
    pageTitle: 'Very Happy Teams — Your coding agents, working together.',
    heroEyebrow: 'VERY HAPPY TEAMS',
    heroTitleA: 'One goal.', heroTitleB: 'A team of', heroTitleC: 'coding agents.',
    heroBody: 'Give your project a team. A lead coordinates Claude Code, Codex, and pi to work in parallel. Follow every task and conversation from your laptop or phone.',
    thesisA: 'DELEGATE. BUILD. REVIEW.', thesisB: 'ONE WORKSPACE FOR THE WHOLE TEAM.',
    primaryCta: 'Connect your first machine', secondaryCta: 'Explore Teams',
    ...
    stepThree: 'Connect and keep it online', stepThreeBody: 'Then open Teams → New team, choose the project and describe your goal. Or start an ordinary conversation.',
...
const zhHans: PublicCopy = {
  ...
  landing: {
    pageTitle: 'Very Happy Teams — 让 coding agent 组成团队，协作推进项目',
    heroEyebrow: 'VERY HAPPY TEAMS',
    heroTitleA: '一个目标', heroTitleB: '一支团队', heroTitleC: '并行推进',
    heroBody: '给项目组一支 coding agent 团队。负责人协调 Claude Code、Codex 和 pi 分头推进，你在电脑或手机上查看任务、对话与结果。',
    thesisA: '分工 · 执行 · 验收', thesisB: '整个团队，一个工作区',
    ...
    stepThree: '连接并保持在线', stepThreeBody: '然后打开“团队 → 新建团队”，选择项目并描述目标；也可以照常新建普通对话。',
