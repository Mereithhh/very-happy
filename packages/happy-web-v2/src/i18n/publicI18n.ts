...
const en = {
  ...
  landing: {
    ...
    metaWeb: 'Web / PWA command surface', metaChoice: 'Choose machine + agent per session', metaHost: 'self-hostable',
...
const zhHans: PublicCopy = {
  ...
  landing: {
    ...
    metaWeb: 'Web / PWA 指挥界面', metaChoice: '每个会话选择机器与 Agent', metaHost: '支持自托管',
