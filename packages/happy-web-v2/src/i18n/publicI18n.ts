...
const en = {
  pwa: {
    ...
    iosSafariOne: 'Tap Share in the Safari toolbar',
    iosChromeOne: 'Tap Share beside the Chrome address bar',
    iosOtherOne: 'Open your browser Share menu',
    iosTwo: 'Choose Add to Home Screen, then confirm Add',
  ...
  landing: {
    pageTitle: 'Very Happy — Your coding agent hub. Work anywhere.',
    heroEyebrow: 'YOUR CODING AGENT HUB',
    heroTitleA: 'Every machine.', heroTitleB: 'Every agent.', heroTitleC: 'Anywhere.',
    heroBody: 'Connect your computers and coding agents in one Web workspace. Open conversations, real terminals, files, and tasks from your laptop or phone. Work with one agent, or bring them together with Teams.',
    thesisA: 'ONE HUB.', thesisB: 'WORK SOLO. BUILD WITH A TEAM. STAY CONNECTED.',
    primaryCta: 'Connect your first machine', secondaryCta: 'Meet Teams',
    metaWeb: 'Web / PWA command surface', metaChoice: 'Claude Code · Codex · pi', metaHost: 'self-hostable',
    ...
    agentsBody: 'Claude Code deep support · Codex available · Gemini available from Web through a compatible ACP stdio endpoint (BETA · IMPLEMENTED) · OpenCode through the CLI ACP beta · any text TUI. pi available through its managed runner. Teams supports Claude Code, Codex, and pi; choose the execution computer explicitly.',
    ...
    stepThree: 'Connect and keep it online', stepThreeBody: 'Open a conversation or terminal on the connected machine. When work calls for a team, choose Teams → New team.',
    ...
    finalBody: 'One agent or a whole team: keep the work in view, from the first idea to the reviewed result.', viewSource: 'View source',
  },
  docs: {
...
const zhHans: PublicCopy = {
  pwa: {
    ...
    iosSafariOne: '点 Safari 工具栏里的“分享”',
    iosChromeOne: '点 Chrome 地址栏旁的“分享”',
    iosOtherOne: '打开浏览器的“分享”菜单',
    iosTwo: '选择“添加到主屏幕”，再确认“添加”',
  ...
  landing: {
    pageTitle: 'Very Happy — 你的 coding agent hub，随时随地接续工作',
    heroEyebrow: 'YOUR CODING AGENT HUB',
    heroTitleA: '每台机器', heroTitleB: '每个 Agent', heroTitleC: '随时随地',
    heroBody: '把你的电脑和 coding agent 连接到同一个工作区。无论在电脑还是手机上，都能接续对话、打开真实终端、查看文件与任务。独立工作，或用 Teams 组织协作。',
    thesisA: '一个 HUB', thesisB: '连接机器，接续工作，组织团队',
    primaryCta: '连接第一台机器', secondaryCta: '了解 Teams',
    metaWeb: 'Web / PWA 指挥界面', metaChoice: 'Claude Code · Codex · pi', metaHost: '支持自托管',
    ...
    agentsBody: '深度支持 Claude Code · 可用 Codex · Gemini 可通过兼容 ACP stdio 端点从 Web 使用（BETA · 已实现）· OpenCode 通过 CLI ACP beta 使用 · 支持任意文本 TUI。pi 已支持托管运行。Teams 可使用 Claude Code、Codex 和 pi，执行电脑由你明确选择。',
    ...
    stepThree: '连接并保持在线', stepThreeBody: '在已连接的机器上打开对话或终端；需要协作时，再选择“团队 → 新建团队”。',
    ...
    finalBody: '一个 agent，或一支团队。从最初的想法，到验收后的结果，都在同一个工作区。', viewSource: '查看源码',
  },
  docs: {
