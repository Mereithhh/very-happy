 ...
 */
export const pt: PartialTranslationStructure = {
    board: {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/Mereithhh/very-happy/issues se você atingir este limite.',
    ...
    session: {
        ...
        completedChanges: ({ count }: { count: number }) => count === 1 ? '1 arquivo alterado' : `${count} arquivos alterados`,
        viewDiff: 'Ver diff',
        newChat: 'Novo chat',
        setTitle: 'Definir título',
        renameTitle: 'Renomear sessão',
        renamePlaceholder: 'Título da sessão',
    ...
    agentInput: {
        ...
        context: {
            ...
            used: ({ percent }: { percent: number }) => `${percent}% de contexto`,
            compact: 'Compactar',
        },
        suggestion: {
            fileLabel: 'ARQUIVO',
    ...
    settingsAccount: {
        ...
        server: 'Servidor',
        backupDescription: 'Faça backup da chave secreta para recuperar a conta sem depender do servidor. Esta versão confia no servidor: o operador pode recuperá-la, e o login com senha ou uma conta Google vinculada também pode devolvê-la. Guarde-a em um gerenciador de senhas.',
    ...
    setPassword: {
        ...
        intro: 'Defina uma senha para entrar em novos dispositivos. O relay confiável a recebe por TLS, armazena apenas um verificador scrypt com salt e retorna a chave da conta mantida pelo servidor após um login bem-sucedido.',
        ...
        errorReauthRequired: 'Por segurança, saia e entre novamente antes de alterar as credenciais.',
    },
    ...
    permissions: {
        pendingCount: ({ count }: { count: number }) => `${count} permissões pendentes`,
