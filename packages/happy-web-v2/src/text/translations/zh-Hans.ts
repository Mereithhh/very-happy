...
export const zhHans: TranslationStructure = {
    ...
    settingsSnippets: {
        navTitle: '快捷片段',
        navSubtitle: 'Prompt 预设 + 终端快捷指令',
        editorTitleLabel: '标题',
        editorTitlePlaceholder: '可选，留空取首行',
        editorCancel: '取消',
        editorSave: '保存',
        editPreset: '编辑 Prompt 预设',
        newPreset: '新建 Prompt 预设',
        editCommand: '编辑快捷指令',
        newCommand: '新建快捷指令',
        deleteTitle: '删除？',
        deleteConfirm: '删除',
        presetsGroup: 'Prompt 预设',
        presetsFooter: '在对话输入框点书签图标快速插入，可二次编辑后再发。',
        addPreset: '添加 Prompt 预设',
