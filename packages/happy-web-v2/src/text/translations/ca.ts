 ...
 */
export const ca: PartialTranslationStructure = {
    board: {
    ...
    session: {
        ...
        completedChanges: ({ count }: { count: number }) => count === 1 ? "1 fitxer canviat" : `${count} fitxers canviats`,
        viewDiff: 'Mostra el diff',
        newChat: 'Nou xat',
        setTitle: 'Defineix el títol',
        renameTitle: 'Reanomena la sessió',
        renamePlaceholder: 'Títol de la sessió',
    ...
    files: {
        ...
        expandSidebar: 'Desplega la barra lateral',
    },
