...
export const zhHant: PartialTranslationStructure = {
    board: {
        ...
        taskDescriptionPlaceholder: '任務描述——會預填為派發會話的第一條訊息',
        createTask: '建立',
        dispatch: '派發',
        markDone: '標記完成',
        editTask: '編輯任務',
    ...
    settingsAppearance: {
        ...
        boardLlm: '看板 AI 分析',
        boardLlmDescription: '任務看板上的 AI 進展、注意力標記與任務歸類由 Happy daemon 生成（本地一次性 haiku 呼叫，有節流）。預設關閉，不會靜默消耗 token。',
        boardLlmHowTo: '在 daemon 機器上設定',
        boardLlmHowToDetail: '在需要分析會話的機器上，把 "boardLlm": true 寫入 ~/.happy/settings.json，然後重啟該機器上的會話。',
    ...
    session: {
        ...
        completedChanges: ({ count }: { count: number }) => `${count} 個檔案變更`,
        viewDiff: '看 diff',
        newChat: '新對話',
        setTitle: '設定標題',
        renameTitle: '重新命名工作階段',
        renamePlaceholder: '工作階段標題',
        forkAction: '分叉會話',
    ...
    commandPalette: {
        ...
        groupTerminals: '終端',
        actionNewChat: '新建對話',
        actionNewChatAdvanced: '新建對話（自訂選項）…',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: '請執行 npm install -g very-happy-cli@latest',
    ...
    terminal: {
        ...
        publicKey: '公鑰',
        encryption: '加密',
        endToEndEncrypted: '伺服器可信中繼',
        acceptConnection: '接受連線',
        connecting: '連線中...',
        reject: '拒絕',
        security: '安全',
        securityFooter: '僅核准您在可信任機器上主動要求的連結。可信任中繼伺服器可存取連線與中繼資料。',
        securityFooterDevice: '僅核准您在可信任機器上主動要求的連線。可信任中繼伺服器可存取連線與中繼資料。',
    ...
    welcome: {
        ...
        installFeatureModels: '最新模型 + 重做的介面',
        installHeading: '在你自己的電腦上執行',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `very-happy daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g very-happy-cli@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
    ...
    settingsSnippets: {
        ...
        editorTitleLabel: '標題',
        editorTitlePlaceholder: '可選，留空取首行',
        editorCancel: '取消',
        editorSave: '儲存',
        editPreset: '編輯快捷指令',
        newPreset: '新增快捷指令',
        ...
        deleteConfirm: '刪除',
        presetsGroup: '快捷指令',
        presetsFooter: '對話輸入框與網頁終端共用一份：選取即填入文字（你按 Enter 送出）；帶「$」標記的項目在終端選取後會直接執行。',
        addPreset: '新增快捷指令',
        startupGroup: '終端啟動命令',
    ...
    tmuxHelp: {
        ...
        mouse: '滑鼠',
        prefix: '前綴鍵',
        prefixNote: '先按 Ctrl-b 放開，再按下面的鍵',
        scrollback: '回看',
        panes: '窗格',
        windows: '視窗',
        session: '工作階段',
        ...
        labelShiftDrag: '用瀏覽器選取複製（繞過 tmux）',
        labelPrefix: '所有 tmux 快捷鍵的前綴',
        labelEnterCopy: '進入回看模式',
        labelScroll: '在回看裡滾動',
        labelQuit: '退出回看',
        labelSplitV: '垂直分割',
        labelSplitH: '水平分割',
        labelMovePanes: '在窗格間切換',
        labelZoom: '目前窗格全螢幕切換',
        labelClosePane: '關閉目前窗格',
        labelNewWindow: '新增視窗',
        labelNextPrev: '下一個 / 上一個',
        labelJump: '依編號跳轉',
