 ...
 */
export const it: PartialTranslationStructure = {
    board: {
    ...
    session: {
        ...
        completedChanges: ({ count }: { count: number }) => count === 1 ? '1 file modificato' : `${count} file modificati`,
        viewDiff: 'Mostra diff',
        newChat: 'Nuova chat',
        setTitle: 'Imposta titolo',
        renameTitle: 'Rinomina sessione',
        renamePlaceholder: 'Titolo della sessione',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Esegui npm install -g very-happy-cli@latest',
    ...
    terminal: {
        ...
        endToEndEncrypted: 'Relay con server fidato',
        acceptConnection: 'Accetta connessione',
        connecting: 'Connessione...',
        reject: 'Rifiuta',
        security: 'Sicurezza',
        securityFooter: 'Approva solo un link richiesto su una macchina fidata. Il relay è server-trusted e può accedere ai dati di connessione e inoltrati.',
        securityFooterDevice: 'Approva solo una connessione richiesta su una macchina fidata. Il relay è server-trusted e può accedere ai dati di connessione e inoltrati.',
    ...
    welcome: {
        ...
        subtitle: 'Il server è un relay fidato e può accedere ai contenuti inoltrati.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `very-happy daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g very-happy-cli@latest`',
        status: 'Stato',
