 ...
 */
export const es: PartialTranslationStructure = {
    board: {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has alcanzado el número máximo de conversaciones de voz este mes. Es posible que en el futuro agreguemos uso de voz bajo demanda — por favor crea un issue en github.com/Mereithhh/very-happy/issues si alcanzas este límite.',
    ...
    session: {
        ...
        completedChanges: ({ count }: { count: number }) => count === 1 ? '1 archivo cambiado' : `${count} archivos cambiados`,
        viewDiff: 'Ver diff',
        newChat: 'Chat nuevo',
        setTitle: 'Establecer título',
        renameTitle: 'Renombrar sesión',
        renamePlaceholder: 'Título de la sesión',
    ...
    permissions: {
        pendingCount: ({ count }: { count: number }) => `${count} permisos pendientes`,
