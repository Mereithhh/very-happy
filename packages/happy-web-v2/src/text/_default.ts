    ...
    changelog: {
        ...
        releases: {
            sep09k: {
                ...
                composer: 'Permissions, model and reasoning controls now sit inside the composer. The plus menu holds attachments and presets; tap the context meter for exact usage.',
