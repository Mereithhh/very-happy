    ...
    changelog: {
        ...
        releases: {
            sep09k: {
                ...
                composer: 'Permissions, model and reasoning controls now sit inside the composer. The plus menu has an explicit Shortcuts entry; tap the context meter for exact usage. The highest reasoning level has a colored progress bar. A single primary button switches between send, queue and stop; steer stays on queued messages.',
