...
export const PI_BRIDGE_TOOLS = ['session_spawn', 'session_send', 'session_read', 'sessions_list', 'session_kill', 'session_archive', 'session_message', 'session_peers', 'report_progress', 'change_title', 'copy_to_clipboard', 'open_preview'] as const;
