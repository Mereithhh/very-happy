...
| B-075 | GitHub Actions 私有仓配额耗尽（2026-08-14 实锤：deploy/publish job 零 step 失败）——本批走本地 deploy.sh + npm pack 直装兜底；待配额恢复 rerun v0.2.38 publish；长期：提额度或 deploy 迁本地为主 | debt | 发布事故 2026-08-14 | todo | happy 技能早有预警（2000 分钟/月）；原登记 B-072 撞号改号 |
