...
Refinement shipped on 2026-09-09: PR #312, `328135d57a2fd0bdb97a56dfee9ed9554613ba40`; exact-main quality run 34333325521 and deploy run 34333884309 succeeded. Active green image is `sha256:3fbbe3b3daf1d156213fc2b1d7fa447612b1a39923bbaa5144ae595c6928b860`; rollback blue retains `6a5f73dc1ea96bc9ee908477151d19021de9b0a1`. CLI remains 0.2.129.

Production health and shipped assets matched the release SHA. An independent Chromium page observed controllerchange and the new entry/CSS before manual reload, with no errors or overflow. The authenticated verification session loaded the same SHA and showed exactly two composer buttons, no exposed slider, and a model popup containing the persisted Fable model plus the effort slider. One older Teams page transiently showed a failed old lazy-chunk load during rollout, then recovered automatically before manual reload; this single observation does not establish a persistent failure.
